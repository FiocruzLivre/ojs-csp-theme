  ...
  })(
	{
		...
		function(t, e, n) {
		  ...
		  (s.Prototype = function() {
			...
			(s.prepareOptions = function(t) {
			  return (
				(t = t || {}),
				(t.nodeTypes = r.extend(s.nodeTypes, t.nodeTypes)),
			  ...
			  r.each(s.nodeTypes, function(n) {
				...
				t.create({
				  ...
				  t.create({
					...
					type: "text",
					content:
					  n.description.name + " uses the following properties:",
				  }),
				...
				r.each(n.description.properties, function(n, r) {
				  ...
				  t.show(
					"content",
					[o + "_example", o + "_example_codeblock"],
					-1
				  );
			  }),
			  t
	  ...
	  13: [
		function(t, e, n) {
		  ...
		  (o.Prototype = function() {
			this.setClasses = function() {
			  r.prototype.setClasses.call(this),
		...
		function(t, e, n) {
		  ...
		  (s.Prototype = function() {
			this.render = function() {
			  ...
			  return (
				this.renderChildren(), this.el.appendChild(this.content), this
			  );
			};
		  }),
			...
			(o.Prototype = function() {
			  (this.getChildrenIds = function() {
				...
				(this.getTitle = function() {
				  return this.properties.title
					? this.document.get(this.properties.title)
					: void 0;
				});
			}),
		  ...
		  (i.type = {
			...
			(i.description = {
			  ...
			  properties: {
				...
				citation_urls:
				  "A list of links for accessing the article on the web",
			  },
			}),
			(i.example = {
				...
				(this.getHeader = function() {
				  return r
					.compact([
					  ...
					  this.properties.citation_type || "Reference",
					])
					.join(" - ");
				});
			}),
		  ...
		  (a.Prototype = function() {
			r.extend(this, s.prototype),
			  (this.renderBody = function() {
				...
				e.source && "" === e.volume
				  ? (s = e.source)
				  : e.source && e.volume && (s = [e.source, e.volume].join(", ")),
				  e.fpage && e.lpage && (a = [e.fpage, e.lpage].join("-"));
				var u = [];
				if (
				  (e.publisher_name &&
					e.publisher_location &&
					(u.push(e.publisher_name), u.push(e.publisher_location)),
		  ...
		  (o.Prototype = function() {
			(this.render = function() {
			  ...
			  (this.renderChildren = function() {
				for (
				  var t = this.node.getChildrenIds(), e = 0;
				  e < t.length;
				  e++
				) {
				  ...
				  this.node.competing_interests.length > 0 &&
					...
					this.content.appendChild(
					  i(".competing-interests", {
						children: r.map(this.node.competing_interests, function(
						  t
						) {
						  return i(".conflict", {
							text: t,
		...
		function(t, e, n) {
		  ...
		  (i.type = {
			...
			(i.description = {
			  ...
			  properties: {
				authors:
				  "A paragraph that has the authors names plus references to the person cards",
			  },
			}),
			(i.example = {
			  id: "cover",
			  ...
			  (this.urls = function() {
				...
				(this.getHeader = function() {
				  return this.properties.label
					? [this.properties.label, this.properties.title].join(". ")
		  ...
		  (o.type = {
			...
			(o.description = {
			  ...
			  properties: {
				...
				url: "Image url",
				caption:
				  "A reference to a caption node that describes the figure",
			...
			(o.Prototype = function() {
			  (this.hasCaption = function() {
				...
				(this.getChildrenIds = function() {
				  var t = [];
				  return (
					this.properties.caption && t.push(this.properties.caption), t
				  );
				}),
				(this.getCaption = function() {
				  return this.properties.caption
					? this.document.get(this.properties.caption)
					: void 0;
				}),
				(this.getHeader = function() {
				  return this.properties.label;
		  ...
		  (i.Prototype = function() {
			(this.render = function() {
			  ...
			  (this.renderTocItem = function() {
				...
				var n = o("span");
				return (
				  this.renderAnnotatedText([this.node.id, "content"], n),
				  t.appendChild(n),
				  t
				);
			  });
	  ...
	  72: [
		function(t, e, n) {
		  "use strict";
		  var r =
			  (t("../../../substance/document").Node, t("../web_resource").Model),
			o = function(t, e) {
			  r.call(this, t, e);
			};
		  (o.type = {
		  ...
		  (o.Prototype = function() {
			...
			(this.render = function() {
			  ...
			  return (
				...
				(this._imgPos = t.call(n.childNodes, r)),
				this
			  );
			}),
			  (this["delete"] = function(t, e) {
				for (
				  var n = this.$(".content")[0], r = n.childNodes, o = e - 1;
				  o >= 0;
				  o--
				)
				  n.removeChild(r[t + o]);
			  ...
			  (this.getCharPosition = function(t, e) {
				return t === this._imgChar
				  ? e > this._imgPos
					? 1
					: 0
				  : void console.log("Errhhh..");
			  }),
			  (this.getDOMPosition = function(t) {
				...
				return (
				  0 === t
					? n.setStartBefore(e.childNodes[0])
					: n.setStartAfter(e.childNodes[0]),
				  n
				);
			  });
		  }),
		  ...
		  (i.whoami = "SubstanceListView"),
			(i.Prototype = function() {
			  (this.render = function() {
				...
				(this.content = document.createElement(t)),
				  this.content.classList.add("content");
				var e;
				for (e = 0; e < this.childrenViews.length; e++)
				  this.childrenViews[e].dispose();
	  ...
	  88: [
		function(t, e, n) {
		  ...
		  (o.description = {
			...
			properties: {
			  source_id:
				"Useful for document conversion where the original id of an element should be remembered.",
			},
		  }),
			(e.exports = o);
		},
	  ...
	  89: [
		function(t, e, n) {
		  ...
		  var r = t("../../../substance/application").View,
			...
			i = function(t, e, n) {
			  if ((r.call(this, n), (this.node = t), (this.viewFactory = e), !e))
				throw new Error(
				  'Illegal argument. Argument "viewFactory" is mandatory.'
				);
			  this.$el
				.addClass("content-node")
				.addClass(t.type.replace("_", "-")),
		  ...
		  (i.Prototype = function() {
			(this.render = function() {
			  ...
			  (this.createTextView = function(t) {
				console.error(
				  "FIXME: NodeView.createTextView() is deprecated. Use NodeView.createTextPropertyView() instead."
				);
		...
		function(t, e, n) {
		  ...
		  (a.Prototype = function() {
			(this.render = function() {
			  ...
			  if (
				this.node.research_organisms &&
				this.node.research_organisms.length > 0
			  ) {
			  ...
			  (this.describePublicationHistory = function() {
				...
				if (
				  (this.node.history &&
					this.node.history.length > 0 &&
					(n = n.concat(this.node.history)),
				  this.node.published_on &&
					n.push({
					  type: "published",
				  ...
				  for (
					e.appendChild(document.createTextNode("The article was ")),
					  t = 0;
					t < n.length;
					t++
				  ) {
			...
			(this.render = function() {
			  ...
			  (this.renderContent = function() {
				(this.content.innerHTML = ""),
				  (this._annotations = this.node.document
			  ...
			  (this.createAnnotationElement = function(t) {
				if (this.options.createAnnotationElement)
				  return this.options.createAnnotationElement.call(this, t);
				var e;
				return (e =
				  "link" === t.type
					? s("a.annotation." + t.type, {
						id: t.id,
		...
		function(t, e, n) {
		  ...
		  (i.type = {
			...
			(i.example = {
			  ...
			  id: "webresource_3",
			  url:
				"http://elife.elifesciences.org/content/elife/1/e00311/F3.medium.gif",
			}),
			(i.Prototype = function() {}),
			(i.Prototype.prototype = o.prototype),
			(i.prototype = new i.Prototype()),
				...
				if (this.options.header) {
				  ...
				  this.options.zoom &&
					e.appendChild(
					  i("a.toggle.toggle-fullscreen", {
						href: "#",
						html: '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/></svg>',
					  })
					),
					t.appendChild(e),
					(this.headerEl = t),
		  ...
		  (s.Prototype = function() {
			...
			(this.test = function(t, e) {
			  ...
			  (this.enhanceCover = function(t, e, n) {
				var r,
				  o = n.querySelector(
					"subj-group[subj-group-type=display-channel] subject"
				  ).textContent;
				try {
				  r = n.querySelector(
				...
				(e.breadcrumbs = [
				  {
					...
					image:
					  "http://lens.elifesciences.org/lens-elife/styles/elife.png",
				  },
				  {
					name: o,
					url:
					  "http://elifesciences.org/category/" +
			  ...
			  (this.enhancePublicationInfo = function(t) {
				var e = t.xmlDoc.querySelector("article"),
				  ...
				  i = n.querySelectorAll(
					"kwd-group[kwd-group-type=research-organism] kwd"
				  ),
				  s = n.querySelectorAll(
					"kwd-group[kwd-group-type=author-keywords] kwd"
				  ),
				...
				l &&
				  ...
				  p.push({
					url:
					  "https://s3.amazonaws.com/elife-cdn/elife-articles/" +
					  t.doc.id +
					  "/elife" +
					  t.doc.id +
					  ".xml",
				  ...
				  r.related_article &&
					(r.related_article =
					  "http://dx.doi.org/" + r.related_article);
			  }),
			  (this.enhanceSupplement = function(t, e) {
				var n = this.getBaseURL(t);
				return n
			  ...
			  (this.enhanceVideo = function(t, e, n) {
				var r = n.getAttribute("xlink:href").split("."),
				  o = r[0];
				(e.url =
				  "http://api.elifesciences.org/v2/articles/" +
				  t.doc.id +
				  "/media/file/" +
				  o +
				  ".mp4"),
		  ...
		  (c.Prototype = function() {
			(this._annotationTypes = {
			  ...
			  (this.isParagraphish = function(t) {
				for (var e = 0; e < t.childNodes.length; e++) {
				  ...
				  if (
					...
					!this.isAnnotation(n.tagName.toLowerCase())
				  )
					return !1;
				}
				return !0;
			  ...
			  (this.getName = function(t) {
				...
				return (
				  r && e.push(r.textContent),
				  n && e.push(n.textContent),
				  o ? [e.join(" "), o.textContent].join(", ") : e.join(" ")
				);
			  }),
			  ...
			  (this.selectDirectChildren = function(t, e) {
				for (
				  var n = [], r = t.querySelectorAll(e), o = 0;
				  o < r.length;
				  o++
				) {
				  var i = r[o];
			  ...
			  (this.extractDate = function(t) {
				...
				var e = t.querySelector("year"),
				  ...
				  o = [e.textContent];
				return (
				  n && o.push(n.textContent),
				  r && o.push(r.textContent),
				  o.join("-")
				);
			  }),
			  ...
			  (this.extractDatasets = function(t, e) {
				for (
				  var n = [], r = t.doc, i = e.querySelectorAll("sec"), s = 0;
				  s < i.length;
				  s++
				) {
				  var a = i[s],
				  ...
				  if ("datasets" === c) {
					...
					r.create(u), n.push(u.id);
					for (
					  var l = this.datasets(t, o.dom.getChildren(a)), p = 0;
					  p < l.length;
					  p++
					)
					  l[p] && n.push(l[p]);
			...
			(this.capitalized = function(e, n) {
			  ...
			  (this.extractAcknowledgements = function(t, e, article, navigationLanguage) {
				var n = [],
				  i = t.doc,
				  s = article.querySelector("back") ? article.querySelector("back").querySelectorAll("ack") : 0;
				return (
				  s &&
					s.length > 0 &&
					r.each(
			  ...
			  (this.extractCustomMetaGroup = function(t, e) {
				...
				for (var s = 0; s < i.length; s++) {
				  ...
				  if (!r.include(this.__ignoreCustomMetaNames, c.textContent)) {
					...
					(l.content = this.annotatedText(t, c, [l.id, "content"])),
					  o.create(l);
				  ...
				  if (p)
					for (
					  ...
					  ("p" === d || "license-p" === d) &&
						...
						c && c.length && (n = n.concat(r.pluck(c, "id"))));
					}
				}
				return n;
			  }),
			  ...
			  (this.contributor = function(t, e) {
				...
				this.extractContributorProperties(t, e, s),
				  0 === s.affiliations.length &&
					(s.affiliations = t.affiliations),
				  s.competing_interests.length > 1 &&
					(s.competing_interests = r.filter(
					  s.competing_interests,
					  function(t) {
						return t.indexOf("no competing") < 0;
					  }
					)),
				  "author" === e.getAttribute("contrib-type") &&
					n.nodes.document.authors.push(i),
				  n.create(s),
				  n.show("info", s.id);
			  }),
				...
				r.each(
				  ...
				  function(r) {
					if ("aff" === r.getAttribute("ref-type")) {
					  ...
					  console.log(
						"FIXME: please add documentation about using 'other' as indicator for extracting an awardGroup."
					  );
					  ...
					  if (m) {
						...
						switch (b) {
						  ...
						  case "equal":
							console.log(
							  "FIXME: isn't fnElem.getAttribute(id) === fnId?"
							),
							  (i = this._getEqualContribs(
								t,
								e,
								m.getAttribute("id")
							  ));
						  ...
						  case "other":
							console.log(
							  ...
							  m.getAttribute("id").indexOf("equal-contrib") >= 0
								? (i = this._getEqualContribs(
									t,
									e,
									m.getAttribute("id")
				...
				for (
				  ...
				  if (!a._converted) {
					...
					"fig" === c
					  ? (u = this.figure(t, a))
					  : "table-wrap" === c
					  ? (u = this.tableWrap(t, a))
					  : "media" === c
					  ? (u = this.video(t, a))
					  : "supplementary-material" === c &&
						(u = this.supplement(t, a)),
					  u && i.push(u);
				  }
				}
				this.show(t, i);
			  ...
			  (this.titleGroup = function(t, e) {
				...
				r &&
				  (n.title = this.annotatedText(t, r, ["document", "title"], {
					ignore: ["xref"],
				  }));
			  }),
			  ...
			  (this["abstract"] = function(t, e, articleMeta) {
				...
				n.create(s),
				  r.push(s),
				  (r = r.concat(
					this.bodyNodes(t, o.dom.getChildren(e), {
			  ...
			  (this.bodyNodes = function(t, e, n) {
				for (var i, s = [], a = 0; a < e.length; a++) {
				  ...
				  if (this._bodyNodes[u]) {
					...
					this._ignoredBodyNodes[u] ||
					(n && n.ignore && n.ignore.indexOf(u) >= 0)
					  ? ((i = this.ignoredNode(t, c, u)), i && s.push(i))
					  : console.error(
						  "Node not yet supported as top-level node: " + u
						);
				}
				return s;
			  }),
				...
				for (var s = o.dom.getChildren(e), a = 0; a < s.length; a++) {
				  ...
				  if ("name" === l)
					for (var p = o.dom.getChildren(u), h = 0; h < p.length; h++) {
					  var d = p[h];
					  if (0 === h)
						(c = this.paragraphGroup(t, d)),
						  r.children.push(c[0].children[0]);
					  else {
						var f = {
						  type: "text",
						  id: t.nextId("text"),
			  ...
			  (this.section = function(t, e) {
				...
				if (
				  ...
				  s && (u.label = s.textContent),
					u.content.length > 0 && (n.create(u), i.unshift(u));
				} else
				  0 === i.length &&
					console.info(
					  "NOTE: skipping section without content:",
					  a ? a.innerHTML : "no title"
					);
			  ...
			  (this.segmentParagraphElements = function(t) {
				for (
				  var e = [], n = "", i = new o.dom.ChildNodeIterator(t);
				  i.hasNext();
				  ...
				  this.ignoredParagraphElements[a] ||
					("text" === a ||
					this.isAnnotation(a) ||
					this.inlineParagraphElements[a]
					  ? ("paragraph" !== n &&
						  (e.push({
							handler: "paragraph",
							nodes: [],
			  ...
			  (this.paragraphGroup = function(t, e) {
				for (
				  var n = [], r = this.segmentParagraphElements(e), o = 0;
				  o < r.length;
				  o++
				) {
				  var i,
					s = r[o];
				  "paragraph" === s.handler
					? ((i = this.paragraph(t, s.nodes)),
					  i && (i.source_id = e.getAttribute("id")))
					: (i = this[s.handler](t, s.node)),
					i && n.push(i);
				}
				return n;
			  }),
			  (this.paragraph = function(t, e) {
				...
				for (
				  var i = {
					...
					s = [],
					a = new o.dom.ChildNodeIterator(e);
				  a.hasNext();
				  ...
				  if ("text" === u || this.isAnnotation(u)) {
					...
					p.length > 0 && ((l.content = p), n.create(l), s.push(l)),
					  t.stack.pop();
			  ...
			  (this.list = function(t, e) {
				...
				for (
				  var i = e.querySelectorAll("list-item"), s = 0;
				  s < i.length;
				  s++
				)
				  for (
					var a = i[s],
					  c = this.bodyNodes(t, o.dom.getChildren(a)),
					  u = 0;
					u < c.length;
					u++
				  )
			  ...
			  (this.formula = function(t, e, n) {
				...
				for (var s = this._getFormulaData(e, n), a = 0; a < s.length; a++)
				  o.format.push(s[a].format), o.data.push(s[a].data);
				return r.create(o), o;
			  }),
			  (this.citationTypes = {
				"mixed-citation": !0,
			  ...
			  (this.ref = function(t, e) {
				for (var n = o.dom.getChildren(e), r = 0; r < n.length; r++) {
				  var i = n[r],
					s = o.dom.getNodeType(i);
				  this.citationTypes[s]
					? this.citation(t, e, i)
					: "label" === s ||
					  console.error("Not supported in 'ref': ", s);
				}
			  }),
			  (this.citation = function(t, e, n) {
				...
				var w = n.querySelector(
				  "pub-id[pub-id-type='doi'], ext-link[ext-link-type='doi']"
				);
				return (
				  w && (r.doi = "http://dx.doi.org/" + w.textContent),
				  i.create(r),
				  i.show("citations", s),
				  r
				);
			  ...
			  (this.createAnnotation = function(t, e, n, o) {
				if (n !== o) {
				  ...
				  this.addAnnotationData(t, s, e, i),
					this.enhanceAnnotationData(t, s, e, i),
			  ...
			  (this.addAnnotationData = function(t, e, n, r) {
				if (
				  ((e.type = this._annotationTypes[r] || "annotation"),
				  "xref" === r)
				)
				  ...
				  ("uri" !== r && "uri" !== o.toLowerCase()) ||
				  /^\w+:\/\//.exec(e.url) ||
				  /^\//.exec(e.url)
					? "doi" === o.toLowerCase() &&
					  (e.url = ["http://dx.doi.org/", e.url].join(""))
					: (e.url = "http://" + e.url);
				} else if ("email" === r)
				  e.url = "mailto:" + n.textContent.trim();
				else if ("inline-graphic" === r)
				  e.url = n.getAttribute("xlink:href");
			  ...
			  (this.addAnnotationDataForXref = function(t, e, n) {
				...
				(e.type = this._refTypeMapping[r] || "cross_reference"),
				  o && (e.target = o);
			  }),
				  ...
				  if (c.nodeType === Node.TEXT_NODE) {
					...
					if (this.isAnnotation(p)) {
					  if (t.top().ignore.indexOf(p) < 0) {
						var h = i;
						(l = this._annotationTextHandler[p]
						  ? this._annotationTextHandler[p].call(this, t, c, p, i)
						  : this._getAnnotationText(t, c, p, i)),
						  (r += l),
						  (i += l.length),
						  t.ignoreAnnotations ||
							this.createAnnotation(t, c, h, i);
					  }
					} else if (a) {
					  if (!s) {
						e.back();
					  ...
					  console.error(
						"Node not yet supported in annoted text: " + p
					  );
					} else
					  t.top().ignore.indexOf(p) < 0 &&
						((l = this._getAnnotationText(t, c, p, i)),
						(r += l),
						(i += l.length));
				  }
				}
			  ...
			  (this._annotationTextHandler["ext-link"] = function(t, e, n, r) {
				...
				return (
				  "ext-link" === n &&
					e.getAttribute("xlink:href") === o.trim() &&
					(o = this.shortenLinkLabel(t, o)),
				  o
				);
			  }),
		  ...
		  (function() {
			function t(t) {
			  ...
			  return function(n, r, o, i) {
				...
				var s = !S(n) && w.keys(n),
				  ...
				  c = t > 0 ? 0 : a - 1;
				return (
				  arguments.length < 3 && ((o = n[s ? s[c] : c]), (c += t)),
				  e(n, r, o, s, c, a)
				);
			  };
			}
			...
			function o(t, e, n) {
			  return function(r, o, i) {
				...
				if (o !== o)
				  return (i = e(h.call(r, s, a), w.isNaN)), i >= 0 ? i + s : -1;
			...
			function i(t, e) {
			  ...
			  for (w.has(t, i) && !w.contains(e, i) && e.push(i); n--; )
				(i = $[n]),
				  i in t && t[i] !== o[i] && !w.contains(e, i) && e.push(i);
			}
			var s = this,
			  a = s._,
			  c = Array.prototype,
			...
			"undefined" != typeof n
			  ? ("undefined" != typeof e && e.exports && (n = e.exports = w),
				(n._ = w))
			  : (s._ = w),
			  (w.VERSION = "1.8.3");
			...
			var C = function(t, e) {
				return function(n) {
				  ...
				  for (var o = 1; r > o; o++)
					for (
					  var i = arguments[o], s = t(i), a = s.length, c = 0;
					  a > c;
					  c++
					) {
					  var u = s[c];
			...
			(w.each = w.forEach = function(t, e, n) {
			  ...
			  (w.find = w.detect = function(t, e, n) {
				var r;
				return (
				  (r = S(t) ? w.findIndex(t, e, n) : w.findKey(t, e, n)),
			  ...
			  (w.every = w.all = function(t, e, n) {
				e = x(e, n);
				for (
				  var r = !S(t) && w.keys(t), o = (r || t).length, i = 0;
				  o > i;
				  i++
				) {
				  var s = r ? r[i] : i;
			  ...
			  (w.shuffle = function(t) {
				for (
				  ...
				  (e = w.random(0, i)), e !== i && (o[i] = o[e]), (o[e] = n[i]);
				return o;
			  }),
			  (w.sample = function(t, e, n) {
				return null == e || n
				  ? (S(t) || (t = w.values(t)), t[w.random(t.length - 1)])
				  : w.shuffle(t).slice(0, Math.max(0, e));
			  }),
			...
			(w.groupBy = A(function(t, e, n) {
			  ...
			  (w.last = function(t, e, n) {
				return null == t
				  ...
				  : null == e || n
				  ? t[t.length - 1]
				  : w.rest(t, Math.max(0, t.length - e));
			  }),
			...
			(w.flatten = function(t, e) {
			  ...
			  (w.uniq = w.unique = function(t, e, n, r) {
				...
				for (var o = [], i = [], s = 0, a = k(t); a > s; s++) {
				  ...
				  e
					? ((s && i === u) || o.push(c), (i = u))
					: n
					? w.contains(i, u) || (i.push(u), o.push(c))
					: w.contains(o, c) || o.push(c);
				}
				return o;
			  }),
			  (w.union = function() {
			  ...
			  (w.intersection = function(t) {
				for (
				  var e = [], n = arguments.length, r = 0, o = k(t);
				  o > r;
				  r++
				) {
				  var i = t[r];
			  ...
			  (w.unzip = function(t) {
				for (
				  var e = (t && w.max(t, k).length) || 0, n = Array(e), r = 0;
				  e > r;
				  r++
				)
				  n[r] = w.pluck(t, r);
			...
			(w.bind = function(t, e) {
			  ...
			  (w.partial = function(t) {
				var e = h.call(arguments, 1),
				  n = function() {
					for (var r = 0, o = e.length, i = Array(o), s = 0; o > s; s++)
					  i[s] = e[s] === w ? arguments[r++] : e[s];
			  ...
			  (w.bindAll = function(t) {
				...
				for (e = 1; r > e; e++)
				  (n = arguments[e]), (t[n] = w.bind(t[n], t));
				return t;
			  }),
				  ...
				  return (
					...
					0 >= l || l > e
					  ? (s && (clearTimeout(s), (s = null)),
						...
						(i = t.apply(r, o)),
						s || (r = o = null))
					  : s || n.trailing === !1 || (s = setTimeout(c, l)),
					i
				  );
				};
			  }),
			...
			(w.keys = function(t) {
			  ...
			  (w.values = function(t) {
				for (
				  var e = w.keys(t), n = e.length, r = Array(n), o = 0;
				  n > o;
				  o++
				)
				  r[o] = t[e[o]];
			  ...
			  (w.mapObject = function(t, e, n) {
				e = x(e, n);
				for (
				  var r, o = w.keys(t), i = o.length, s = {}, a = 0;
				  i > a;
				  a++
				)
				  (r = o[a]), (s[r] = e(t[r], r, t));
			  ...
			  (w.invert = function(t) {
				for (var e = {}, n = w.keys(t), r = 0, o = n.length; o > r; r++)
				  e[t[n[r]]] = n[r];
				return e;
			  }),
			...
			var I = function(t, e, n, r) {
			  ...
			  if ((n.push(t), r.push(e), i)) {
				...
				for (; c--; )
				  if (((u = l[c]), !w.has(e, u) || !I(t[u], e[u], n, r)))
					return !1;
			  }
			...
			(w.isEqual = function(t, e) {
			  ...
			  (w.isEmpty = function(t) {
				return null == t
				  ? !0
				  : S(t) && (w.isArray(t) || w.isString(t) || w.isArguments(t))
				  ? 0 === t.length
				  : 0 === w.keys(t).length;
			  }),
			...
			var M = {
			  ...
			  R = function(t) {
				...
				return function(t) {
				  return (
					(t = null == t ? "" : "" + t), r.test(t) ? t.replace(o, e) : t
				  );
				};
			  };
			(w.escape = R(M)),
		  ...
		  var r = t("underscore"),
			...
			l = function(t) {
			  i.call(this),
				...
				(this.converterOptions = r.extend(
				  {},
				  u.DefaultOptions,
				  t.converterOptions
				)),
			...
			(this.createView = function() {
			  ...
			  (this.convertDocument = function(t) {
				for (var e, n = 0; !e && n < this.converters.length; ) {
				  ...
				  r.test(t, this.config.document_url) && (e = r["import"](t)),
					(n += 1);
				}
				if (!e)
				  throw new Error(
					"No suitable converter found for this document",
					t
				  );
				return e;
			  }),
		  ...
		  var r = t("underscore"),
			...
			s = function(t, e) {
			  i.call(this, e),
				...
				this.options.viewFactory
				  ? (this.viewFactory = this.options.viewFactory)
				  : (this.viewFactory = new this.document.constructor.ViewFactory(
					  this.document.nodeTypes
					)),
		  ...
		  (s.Prototype = function() {
			(this.handleDroppedFile = function() {
			  ...
			  (this.onStateChanged = function() {
				...
				"reader" === t.context
				  ? this.openReader()
				  : console.log("Unknown application state: " + t);
			  }),
	  ...
	  133: [
		function(t, e, n) {
		  ...
		  var r = t("../../substance/document"),
			...
			a = function(t, e) {
			  o.call(this, t, e),
				(this.docCtrl = new r.Controller(t, {
				  view: e.container,
				}));
			};
		  (a.Prototype = function() {
			(this.createView = function() {
			  var t,
				e = this.getDocument();
			  if ("resource" === this.config.type)
				t = this.config.createViewFactory
				  ? this.config.createViewFactory(e, this.config)
				  : new i(e.nodeTypes, this.config);
			  else {
			...
			(this.render = function() {
			  ...
			  (this.scrollTo = function(t) {
				...
				if (e) {
				  ...
				  (i = n + s - a),
					this.surface.$el.scrollTop(i),
					this.scrollbar.update();
				} else
				  console.info(
					"ContainerPanelView.scrollTo(): Unknown resource '%s'",
					t
				  );
			  }),
			  (this.findNodeView = function(t) {
			  ...
			  (this.markActiveHeading = function(t) {
				var e = $(".nodes").height(),
				  ...
				  o = function(t) {
					...
					return (
					  e || (e = this.tocNodeElements[t] = this.findNodeView(t)), e
					);
				  }.bind(this);
				if (0 !== n.length) {
				  var i;
				  o(n[0].id);
				  if (((i = n[0].id), t + this.$el.height() >= e))
					i = r.last(n).id;
				  else
					for (var s = n.length - 1; s >= 1; s--) {
					  ...
					  if (u) {
						...
						console.error("Could not find element for node %s", c.id);
					}
				...
				: (i.each(
					...
					function(e) {
					  ...
					  (o.id = "toc_" + e.id),
						...
						s.addClass("level-" + r),
						s.click(i.bind(this.onClick, this, e.id)),
		  ...
		  var r = t("underscore"),
			...
			a = function(t, e) {
			  s.call(this),
				...
				(this.name = e.name),
				(this.toggleEl = i("a.context-toggle." + this.name, {
				  href: "#",
				...
				(this._onToggleResourceReference = r.bind(
				  this.onToggleResourceReference,
				  this
				)),
				(this._onToggleFullscreen = r.bind(
				...
				this.$el.on(
				  "click",
				  ".annotation.resource-reference",
				  this._onToggleResourceReference
				),
		  ...
		  var r = t("../../article").ViewFactory,
			o = function(t, e) {
			  r.call(this, t),
				...
				void 0 === this.options.zoom &&
				  (this.options.zoom = o.enableZoom);
			};
		  (o.Prototype = function() {
			this.createView = function(t, e, n) {
			  e = e || {};
			  var r = this.getNodeViewClass(t, n);
			  e.topLevel &&
				r.prototype.isResourceView &&
				this.options.header &&
				((e.header = !0),
				r.prototype.isZoomable && this.options.zoom && (e.zoom = !0));
		  ...
		  (s.Prototype = function() {
			(this.render = function() {
			  ...
			  (this.updateOverlay = function(t, e) {
				...
				r < s.OverlayMinHeight &&
				  ((r = s.OverlayMinHeight), (o -= 0.5 * s.OverlayMinHeight)),
				  e.css({
					height: r,
					top: o,
				  });
			  ...
			  (this.mouseDown = function(t) {
				...
				var e = t.pageY;
				return (
				  t.target !== this.visibleArea
					? ((this.offset = $(this.visibleArea).height() / 2),
					  this.mouseMove(t))
					: (this.offset = e - $(this.visibleArea).position().top),
				  !1
				);
			  }),
			  ...
			  (this.mouseMove = function(t) {
				if (this._mouseDown) {
				  ...
				  (this.scrollTop = this.surface.$el.scrollTop(n)),
					this.updateVisibleArea();
				}
			  }),
			  (this.onScroll = function() {
		  ...
		  var r = t("underscore"),
			...
			c = function(t) {
			  o.call(this),
				...
				(this.resources = new s(this.readerCtrl.getDocument(), {
				  types: ["resource_reference"],
				  property: "target",
				})),
			...
			(this.render = function() {
			  ...
			  (this.updateState = function() {
				var t,
				  ...
				  o = {
					focussedNode: n.focussedNode
					  ? this.doc.get(n.focussedNode)
					  : null,
				  },
				  i =
					"content" === n.panel
					  ? this.contentView
					  : this.panelViews[n.panel];
				if (
				  ...
				  n.fullscreen && s.push("fullscreen"),
					i.addHighlight(n.focussedNode, s.join(" ")),
					i.scrollTo(n.focussedNode);
				}
				if (
				  (this.lastWorkflow &&
					(t = this.lastWorkflow.handleStateUpdate(n, o)),
				  !t)
				)
				  for (var a = 0; a < this.readerCtrl.workflows.length; a++) {
					...
					if (
					  c !== this.lastWorkflow &&
					  c.handlesStateUpdate &&
					  (t = c.handleStateUpdate(n, o))
					) {
					  this.lastWorkflow = c;
					  break;
					}
			  ...
			  (this.showPanel = function(t) {
				this.panelViews[t]
				  ? (this.panelViews[t].activate(), (this.el.dataset.context = t))
				  : "content" === t &&
		  ...
		  var r = t("underscore"),
			...
			i = function() {
			  o.apply(this, arguments),
				(this._followCrossReference = r.bind(
				  this.followCrossReference,
				  this
				));
			};
		  (i.Prototype = function() {
			(this.registerHandlers = function() {
			  this.readerView.$el.on(
				"click",
				".annotation.cross_reference",
				this._followCrossReference
			  );
			}),
			  (this.unRegisterHandlers = function() {
				this.readerView.$el.off(
				  "click",
				  ".annotation.cross_reference",
				  this._followCrossReference
				);
		...
		function(t, n, r) {
		  ...
		  (s.Prototype = function() {
			(this.registerHandlers = function() {
			  this.readerView.$el.on(
				"click",
				".document .content-node.heading .top",
				this._gotoTop
			  );
			}),
			  (this.unRegisterHandlers = function() {
		  ...
		  (i.Prototype = function() {
			(this.registerHandlers = function() {}),
			  ...
			  (this.handleStateUpdate = function(t, e) {
				if (
				  e.focussedNode &&
				  this.readerView.panelForRef[e.focussedNode.type]
				) {
				...
				i.each(
				  ...
				  function(t) {
					this.router.route(
					  t.route,
					  t.name,
					  i.bind(this.controller[t.command], this.controller)
					);
				  },
				  this
				),
		...
		function(t, e, n) {
		  ...
		  (i.Prototype = function() {
			(this.updateState = function(t, e) {
			  console.error(
				"updateState is deprecated, use modifyState. State is now a rich object where context replaces the old state variable"
			  );
			  var n = this.context;
			  (this.context = t),
				(this.state = e),
			  ...
			  (this.modifyState = function(t) {
				...
				o.extend(this.state, t),
				  t.context &&
					t.context !== e &&
					this.trigger("context-changed", t.context),
	  ...
	  154: [
		function(t, e, n) {
		  ...
		  (r.View = t("./view")),
			...
			(r.ElementRenderer = t("./renderers/element_renderer")),
			(r.$$ = r.ElementRenderer.$$),
			(e.exports = r);
		},
		{
			...
			route: function(t, e, n) {
			  ...
			  return (
				i.history.route(t, function(o) {
				  ...
				  n && n.apply(r, s),
					r.trigger.apply(r, ["route:" + e].concat(s)),
					r.trigger("route", e, s),
					i.history.trigger("route", r, e, s);
				}),
				this
			  );
			},
				...
				return this._wantsHashChange &&
				  ...
				  : (this._wantsPushState &&
					  ...
					  this.history.replaceState(
						{},
						document.title,
						this.root + this.fragment + i.search
					  )),
		...
		function(t, e, n) {
		  ...
		  var r = t("../../substance/util"),
			o = function(t) {
			  t = t || {};
			  (this.el =
				t.el || window.document.createElement(t.elementType || "div")),
				(this.$el = $(this.el)),
			...
			(this.$ = function(t) {
			  ...
			  (this.dispatchDOMEvents = function() {
				...
				this.$el.delegate("[sbs-click]", "click", function(n) {
				  console.error(
					"FIXME: sbs-click is deprecated. Use jquery handlers with selectors instead."
				  );
			  ...
			  if (
				...
				throw new u(
				  [
					...
					" Actual: ",
					e.seed.schema[0] + "@" + e.seed.schema[1],
				  ].join("")
				);
			  (this.nodes = {}),
				(this.indexes = {}),
		  ...
		  (h.Prototype = function() {
			r.extend(this, o.Events),
			  ...
			  (this.set = function(t, e) {
				...
				if (!n)
				  throw new u(
					"Could not resolve property with path " + JSON.stringify(t)
				  );
				var r = n.get();
				n.set(e),
				  this._updateIndexes({
			  ...
			  (this.get = function(t) {
				if (!r.isArray(t) && !r.isString(t))
				  throw new u("Invalid argument path. Must be String or Array");
				if (
				  (arguments.length > 1 && (t = r.toArray(arguments)),
				  r.isString(t))
				)
				  return this.nodes[t];
			  ...
			  (this.query = function(t) {
				var e = this.resolve(t),
				  ...
				  o = e.get();
				return "array" === r
				  ? this._queryArray.call(this, o, n)
				  : p(r)
				  ? o
				  : this.get(o);
			  }),
			  ...
			  (this.init = function() {
				(this.__is_initializing__ = !0),
				  this.__seed__
					? (this.nodes = o.clone(this.__seed__.nodes))
					: (this.nodes = {}),
			  ...
			  (this.addIndex = function(t, e) {
				if (this.indexes[t])
				  throw new u("Index with name " + t + "already exists.");
				var n = new c(this, e);
			  ...
			  (this._queryArray = function(t, e) {
				if (!r.isArray(e))
				  throw new u(
					"Illegal argument: array types must be specified as ['array'(, 'array')*, <type>]"
				  );
				var n, o;
				if ("array" === e[1])
				  for (n = [], o = 0; o < t.length; o++)
			...
			i = function(t, e) {
			  (e = e || {}),
				...
				e.filter
				  ...
				  : e.types && (this.filter = i.typeFilter(t.schema, e.types)),
			  ...
			  (this.applyOp = function(t) {
				if ("create" === t.type) this._add(t.val);
				  ...
				  "set" === t.type
					? (e = t.original)
					: console.error(
						"Operational updates are not supported in this implementation"
					  ),
					this._update(n.node, n.key, r, e);
				}
			  }),
		  ...
		  var r = t("underscore"),
			o = function(t, e) {
			  ...
			  (this.graph = t),
				...
				r.extend(this, this.resolve(e));
			};
		  (o.Prototype = function() {
			(this.resolve = function(t) {
			  for (
				var e, n, r = this.graph, o = r, i = "graph", s = 0;
				s < t.length;
				s++
			  )
				if ("graph" === i || void 0 !== this.schema.types[i]) {
				  ...
				  (r = o),
					(i = this.schema.properties(o.type)),
					(n = r),
					(e = void 0);
				} else {
		  ...
		  (s.Prototype = function() {
			var t = function(t, e) {
			  ...
			  for (var o, s; r.length > 0; ) {
				if (
				  ((o = r.shift()), (s = this.document.get(o.id)), s instanceof i)
				) {
				  var a = s.getNodes();
			...
			(this.rebuild = function() {
			  this.treeView.splice(0, this.treeView.length),
				...
				(this.treeView = r.clone(this.view.nodes));
			  for (var e = 0; e < this.view.length; e++)
				this.treeView.push(this.view[e]);
			  (this.__parents = {}),
				(this.__composites = {}),
				t.call(
				  this,
				  function(t, e) {
					if (t instanceof i)
					  ...
					  if ((this.listView.push(t.id), this.__parents[t.id]))
			  ...
			  (this.getSuccessor = function(t) {
				var e = this.getPosition(t);
				return e >= this.getLength() - 1
				  ? null
				  : this.getNodeFromPosition(e + 1);
			  }),
			  ...
			  (this.getIndex = function(t) {
				...
				(this.get = function(e) {
				  ...
				  if ("view" === n.type)
					return (
					  this.containers[n.id] ||
						(this.containers[n.id] = new a(this, n)),
					  this.containers[n.id]
					);
				  ...
				  return (
					!o ||
					  n instanceof o ||
					  ((n = new o(n, this)), (this.nodes[n.id] = n)),
					n
				  );
				}),
				(this.toJSON = function() {
				...
				(this.hide = function(t, e) {
				  ...
				  if (
					...
					for (var i = this.nodes[t], s = 0; s < o.length; s++)
					  i.nodes.splice(o[s], 1);
				  }
				}),
				(this.show = function(t, e, n) {
				  ...
				  (n = Math.min(n, o)),
					0 > n && (n = Math.max(0, o + n + 1)),
					r.nodes.splice(n, 0, e);
				}),
				(this.fromSnapshot = function(t, e) {
		...
		function(t, e, n) {
		  ...
		  function r(t, e) {
			function n(t) {
			  ...
			  if (!e)
				return l.length > 0
				  ? r(new Error("Multiple errors occurred.", t))
				  : r(null, t);
			  ...
			  try {
				...
				console.log("util.async caught error:", p),
				  s.printStackTrace(p),
				  r(p);
			  }
			}
	  ...
	  171: [
		function(t, e, n) {
		  ...
		  (o.ChildNodeIterator = function(t) {
			r.isArray(t) ? (this.nodes = t) : (this.nodes = t.childNodes),
			...
			(o.getNodeType = function(t) {
			  return t.nodeType === window.Node.TEXT_NODE
				? "text"
				: t.nodeType === window.Node.COMMENT_NODE
				? "comment"
				: t.tagName
				? t.tagName.toLowerCase()
				: (console.error("Can't get node type for ", t), "unknown");
			}),
			(e.exports = o);
		},
		{
	  ...
	  172: [
		function(t, e, n) {
		  ...
		  var r = t("./util"),
			...
			i = function(t, e) {
			  e
				? (Error.call(this, t, e.fileName, e.lineNumber),
				  e instanceof i
					? (this.__stack = e.__stack)
					: e.stack
					? (this.__stack = r.parseStackTrace(e))
					: (this.__stack = r.callstack(1)))
			...
			(this.onText = function() {}),
			  ...
			  (this.start = function(n, r, s) {
				...
				for (
				  ...
				  var p = a[l];
				  this.createText(c[c.length - 1].context, r.substring(u, p.pos)),
					(u = p.pos);
				  var h,
					d = 1;
				  if (p.mode === o) {
					...
					for (h = d; h < c.length; h++)
					  this.exit(c[h].entry, c[h - 1].context);
					c.splice(d, 1);
				  }
				  for (h = d; h < c.length; h++)
					c[h].context = this.enter(c[h].entry, c[h - 1].context);
				}
		...
		function(t, e, n) {
		  ...
		  var i = function(t, e) {
			...
			a = function(t, e, n, r) {
			  ...
			  if (s.test(n)) {
				for (var i = n.split(s), a = 0, c = i.length; c > a; a++)
				  t[e].apply(t, [i[a]].concat(r));
				return !1;
			  }
			  return !0;
			};
		  o.Events = {
			...
			off: function(t, e, n) {
			  ...
			  for (
				c = t ? [t] : r.keys(this._events), u = 0, l = c.length;
				l > u;
				u++
			  )
				if (((t = c[u]), (s = this._events[t]))) {
				  if (((this._events[t] = o = []), e || n))
					for (p = 0, h = s.length; h > p; p++)
					  (i = s[p]),
			...
			stopListening: function(t, e, n) {
			  ...
			  "object" == typeof e && (n = this),
				t && ((r = {})[t._listenerId] = t);
			  for (var i in r)
				r[i].off(e, n, this), o && delete this._listeners[i];
			  return this;
			},
		  };
		  var c = {
		  ...
		  r.each(c, function(t, e) {
			...
			(o.Events.Listener = {
			  listenTo: function(t, e, n) {
				if (!r.isFunction(n))
				  throw new Error(
					"Illegal argument: expecting function as callback, was: " + n
				  );
				return (
		  ...
		  (o.inherits = function(t, e, n) {
			...
			(o.stacktrace = function(t) {
			  var e =
				  0 === arguments.length
					? o.callstack().splice(1)
					: o.parseStackTrace(t),
				n = [];
			  return (
				r.each(e, function(t) {
				  n.push(
					t.file + ":" + t.line + ":" + t.col + " (" + t.func + ")"
				  );
				}),
				n.join("\n")
			  );
			...
			(o.slug = function(t) {
			  ...
			  for (
				var e = "àáäâèéëêìíïîòóöôùúüûñç·/_,:;",
				...
				t = t.replace(new RegExp(e.charAt(r), "g"), n.charAt(r));
			  return (t = t
				.replace(/[^a-z0-9 -]/g, "")
				.replace(/\s+/g, "-")
				.replace(/-+/g, "-"));
